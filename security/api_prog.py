...
class Markit:
    def __init__(self):
        ...
        self.lookup_url = "https://financialmodelingprep.com/api/v3/quote/AMZN?apikey=e47d0238439c89feffbbdd45d32c77ce"
...
def get_stock_price(string):
    ...
    if string is not None:
        ...
        url_concat = "https://financialmodelingprep.com/api/v3/quote/"+string+"?apikey=e47d0238439c89feffbbdd45d32c77ce"
        r = requests.get(url_concat)
        if r.status_code == 200:
            data = r.json()
            # lis = []
...
# Api Key - e47d0238439c89feffbbdd45d32c77ce